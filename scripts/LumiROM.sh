...
APPLY_FLOATING_FEATURE() {
    ...
    UPDATE_FLOATING_FEATURE "SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION" "    <SEC_FLOATING_FEATURE_AUDIO_CONFIG_SOUNDALIVE_VERSION>eq_custom,uhq_onoff,karaoke,adapt,spk_stereo,dvfs_25_percent"
    ...
    UPDATE_FLOATING_FEATURE "SEC_FLOATING_FEATURE_AUDIO_SUPPORT_DUAL_SPEAKER" "TRUE"
    ...
    UPDATE_FLOATING_FEATURE "SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_AOD_ITEM" "aodversion=7,clocktransition"
    ...
    #========== VIDEO EDITOR ==========#
    UPDATE_FLOATING_FEATURE "SEC_FLOATING_FEATURE_COMMON_CONFIG_MULTIMEDIA_EDITOR_PLUGIN_PACKAGES" "$(awk -F'[<>]' '$2 == "SEC_FLOATING_FEATURE_COMMON_CONFIG_MULTIMEDIA_EDITOR_PLUGIN_PACKAGES" {print $3}' "$STOCK_FLOATING_FEATURE")"
}
...
LUMI_BOMBS() {
    ...
    if [ -d "$OVERLAY" ]; then
        ...
        for MOD in "$OVERLAY"/*; do
            ...
            sudo rsync -avi --progress "$MOD"/ "FIRMWARE"/
